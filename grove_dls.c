...
int suas_dls_init() {
  ...
  result = suas_dls_write_byte((char *)&POWER_UP_DATA,
  ...
  result = suas_dls_write_byte((char *)&POWER_DOWN_DATA,
...
// Called internally by the functions readIRLuminosity, readFSLuminosity and
...
// Taken from
// https://github.com/Seeed-Studio/Grove_Digital_Light_Sensor/blob/master/Digital_Light_TSL2561.cpp
...
static unsigned long suas_dls_calculate_lux(unsigned int iGain,
                                            unsigned int tInt, int iType) {
