...
typedef struct suas_pwm_conf_t {
  ...
  uint32_t frequency : 23; /* Frequency (must be between 2,000 and 800,000, can
                             be adjusted with the divider); 20 bits are
                             sufficient but half bytes can not be used anyway */
